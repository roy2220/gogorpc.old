...
func init() { proto.RegisterFile("gogorpc.proto", fileDescriptor_28dabeb111b4aab1) }
...
func (m *Error) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i -= len(m.Name)
	copy(dAtA[i:], m.Name)
	i = encodeVarintGogorpc(dAtA, i, uint64(len(m.Name)))
	i--
	dAtA[i] = 0xa
	return len(dAtA) - i, nil
}
	...
	for iNdEx < l {
		...
		case 3:
			for {
				...
				next, err := skipGogorpc(dAtA[start:])
				if err != nil {
					return 0, err
				}
				iNdEx = start + next
