...
// source: github.com/let-z-go/gogorpc/examples/helloworld/protocol/helloworld.proto
...
func init() {
	proto.RegisterFile("github.com/let-z-go/gogorpc/examples/helloworld/protocol/helloworld.proto", fileDescriptor_26e64aa10a5ad2e8)
}
