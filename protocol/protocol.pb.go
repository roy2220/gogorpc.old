...
type RequestHeader struct {
	...
	SpanParentId   int32  `protobuf:"varint,2,opt,name=span_parent_id,json=spanParentId,proto3" json:"span_parent_id,omitempty"`
	SpanId         int32  `protobuf:"varint,3,opt,name=span_id,json=spanId,proto3" json:"span_id,omitempty"`
...
func (m *RequestHeader) GetSpanParentId() int32 {
	if m != nil {
		return m.SpanParentId
	}
	return 0
}
...
type ResponseHeader struct {
	NextSpanId     int32 `protobuf:"varint,1,opt,name=next_span_id,json=nextSpanId,proto3" json:"next_span_id,omitempty"`
...
func (m *RequestHeader) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SpanParentId != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintProtocol(dAtA, i, uint64(m.SpanParentId))
	}
	if m.SpanId != 0 {
		dAtA[i] = 0x18
		i++
...
func (m *RequestHeader) Size() (n int) {
	...
	if m.SpanParentId != 0 {
		n += 1 + sovProtocol(uint64(m.SpanParentId))
	}
	if m.SpanId != 0 {
...
func (m *RequestHeader) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SpanParentId", wireType)
			}
			m.SpanParentId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SpanParentId |= (int32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorProtocol = []byte{
	...
	,
}
