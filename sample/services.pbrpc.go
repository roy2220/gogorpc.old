...
func (ClientServiceHandlerBase) X_GetMethodTable() pbrpc.MethodTable {
	return methodTableOfClientService
}
...
var methodTableOfClientService = pbrpc.MethodTable{
	ClientService_GetNickname: {
		Index:        ClientService_GetNickname,
		Name:         "GetNickname",
		RequestType:  reflect.TypeOf(pbrpc.Void{}),
		ResponseType: reflect.TypeOf(GetNicknameResponse{}),

		Handler: func(serviceHandler pbrpc.ServiceHandler, context_ context.Context, _ interface{}) (pbrpc.OutgoingMessage, error) {
			methodHandler, ok := serviceHandler.(interface {
				GetNickname(context.Context) (*GetNicknameResponse, error)
			})
...
func (ServerServiceHandlerBase) X_GetMethodTable() pbrpc.MethodTable {
	return methodTableOfServerService
}
...
var methodTableOfServerService = pbrpc.MethodTable{
	ServerService_SayHello: {
		Index:        ServerService_SayHello,
		Name:         "SayHello",
		RequestType:  reflect.TypeOf(SayHelloRequest{}),
		ResponseType: reflect.TypeOf(SayHelloResponse{}),

		Handler: func(serviceHandler pbrpc.ServiceHandler, context_ context.Context, request interface{}) (pbrpc.OutgoingMessage, error) {
			methodHandler, ok := serviceHandler.(interface {
